...
<!--TELO-->
<main>
<div>Unesite Ova epizode</div>
<form action="unosovaepizodex.php" method="post" enctype="multipart/form-data">
<input type="text" name="tip" placeholder="Tip">
<input type="text" name="red" placeholder="Redni broj ova epizode">
...
<input type="text" name="datum" placeholder="Datum emitovanja">
