...
<?php
$sql = "SELECT * FROM ovaepizode ORDER BY red";
$upit = mysqli_query($conn,$sql);
while($red = mysqli_fetch_assoc($upit)) { ?>
<?php
$id = $red["id"];
?>
<a href="<?php echo 'ovaepizodeprikaz.php?id='.$id; ?>" title="<?=$red['red']?>" style="width:360px; height:360px; margin:10px; display:block; float:left; border-radius:10px; border:solid 2px #f00;"><img src="<?=$red['slika']?>" style="object-fit:contain; width:100%; height:100%;"></a>
