...
$sql="INSERT INTO vesti (tip, naziv, opis, novost, slika1, slika2, slika3, slika4, slika5, slika6, slika7, slika8, slika9, slika10, text1, text2, youtube) VALUES ('$tip', '$naziv', '$opis', '$novost', '$slika1', '$slika2', '$slika3', '$slika4', '$slika5', '$slika6', '$slika7', '$slika8', '$slika9', '$slika10', '$text1', '$text2', '$youtube')";
