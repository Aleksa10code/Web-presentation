...
<!--TELO-->
<main>
<div>Unesite Specijal</div>
<form action="unosspecijalax.php" method="post" enctype="multipart/form-data">
<input type="text" name="tip" placeholder="Tip">
<input type="text" name="red" placeholder="Redni broj specijala">
